 ...
 * @author hillchen
 */
public interface BeanFactoryProcessorResort {
     ...
     */
    BeanFactoryPostProcessor getBeforeFactoryBeanProcessor(ApplicationContext applicationContext) ;
     ...
     */
    BeanFactoryPostProcessor getAfterFactoryBeanProcessor(ApplicationContext applicationContext);
